from config_transformer import BATCH_SIZE, loss_fn as l, run_name, EPOCH_NUM, error_file_name
...
from model.ResNet_li_transformer import MyResNet
...
def count_parameters(model):
	return sum(p.numel() for p in model.parameters() 
		if p.requires_grad)
print("model参数量: ", count_parameters(model))   # 1420w
# 将transformer encoder的层数调成2时，参数量降到了900w
